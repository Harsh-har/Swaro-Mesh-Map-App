...
import no.nordicsemi.android.swarorgbww.transport.InternalElementListDeserializer;
import no.nordicsemi.android.swarorgbww.transport.MeshModel;
import no.nordicsemi.android.swarorgbww.transport.MeshModelListDeserializer;
import no.nordicsemi.android.swarorgbww.transport.NodeDeserializer;
                    ...
                    public JsonElement serialize(ProvisionedMeshNode src, Type typeOfSrc,
                        ...
                        if (src.getDeviceKey() != null) {
                            jsonObject.addProperty("deviceKey",
                                    no.nordicsemi.android.swarorgbww.utils.MeshParserUtils.bytesToHex(
                        ...
                        jsonObject.addProperty("unicastAddress",
                                no.nordicsemi.android.swarorgbww.utils.MeshParserUtils.bytesToHex(
                                        no.nordicsemi.android.swarorgbww.utils.MeshAddress.addressIntToBytes(
