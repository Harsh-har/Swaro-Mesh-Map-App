...
import static no.nordicsemi.android.swarorgbww.transport.TimeStatus.SUB_SECOND_BIT_SIZE;
import static no.nordicsemi.android.swarorgbww.transport.TimeStatus.TAI_SECONDS_BIT_SIZE;
import static no.nordicsemi.android.swarorgbww.transport.TimeStatus.TIME_AUTHORITY_BIT_SIZE;
import static no.nordicsemi.android.swarorgbww.transport.TimeStatus.TIME_BIT_SIZE;
import static no.nordicsemi.android.swarorgbww.transport.TimeStatus.TIME_ZONE_OFFSET_BIT_SIZE;
import static no.nordicsemi.android.swarorgbww.transport.TimeStatus.TIME_ZONE_START_RANGE;
import static no.nordicsemi.android.swarorgbww.transport.TimeStatus.UNCERTAINTY_BIT_SIZE;
import static no.nordicsemi.android.swarorgbww.transport.TimeStatus.UTC_DELTA_BIT_SIZE;
import static no.nordicsemi.android.swarorgbww.transport.TimeStatus.UTC_DELTA_START_RANGE;

import androidx.annotation.NonNull;

import no.nordicsemi.android.swarorgbww.ApplicationKey;
import no.nordicsemi.android.swarorgbww.MeshTAITime;
