...
import no.nordicsemi.android.swarorgbww.sensorutils.StatusTriggerDelta;
import no.nordicsemi.android.swarorgbww.sensorutils.StatusTriggerType;

import static java.nio.ByteOrder.LITTLE_ENDIAN;
import static no.nordicsemi.android.swarorgbww.sensorutils.StatusTriggerDelta.Characteristic;
import static no.nordicsemi.android.swarorgbww.sensorutils.StatusTriggerDelta.Percent;
import static no.nordicsemi.android.swarorgbww.sensorutils.StatusTriggerType.from;
import static no.nordicsemi.android.swarorgbww.utils.MeshParserUtils.unsignedBytesToInt;
