...
import static no.nordicsemi.android.swaromapmesh.transport.TimeStatus.SUB_SECOND_BIT_SIZE;
import static no.nordicsemi.android.swaromapmesh.transport.TimeStatus.TAI_SECONDS_BIT_SIZE;
import static no.nordicsemi.android.swaromapmesh.transport.TimeStatus.TIME_AUTHORITY_BIT_SIZE;
import static no.nordicsemi.android.swaromapmesh.transport.TimeStatus.TIME_BIT_SIZE;
import static no.nordicsemi.android.swaromapmesh.transport.TimeStatus.TIME_ZONE_OFFSET_BIT_SIZE;
import static no.nordicsemi.android.swaromapmesh.transport.TimeStatus.TIME_ZONE_START_RANGE;
import static no.nordicsemi.android.swaromapmesh.transport.TimeStatus.UNCERTAINTY_BIT_SIZE;
import static no.nordicsemi.android.swaromapmesh.transport.TimeStatus.UTC_DELTA_BIT_SIZE;
import static no.nordicsemi.android.swaromapmesh.transport.TimeStatus.UTC_DELTA_START_RANGE;

import androidx.annotation.NonNull;

import no.nordicsemi.android.swaromapmesh.ApplicationKey;
import no.nordicsemi.android.swaromapmesh.MeshTAITime;
