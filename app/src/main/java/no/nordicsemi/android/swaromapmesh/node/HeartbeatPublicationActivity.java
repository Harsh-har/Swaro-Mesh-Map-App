...
import static no.nordicsemi.android.swaromapmesh.Features.DISABLED;
import static no.nordicsemi.android.swaromapmesh.Features.ENABLED;
import static no.nordicsemi.android.swaromapmesh.utils.Heartbeat.COUNT_MIN;
import static no.nordicsemi.android.swaromapmesh.utils.Heartbeat.DEFAULT_PUBLICATION_TTL;
import static no.nordicsemi.android.swaromapmesh.utils.Heartbeat.PERIOD_LOG_MIN;
import static no.nordicsemi.android.swaromapmesh.utils.Heartbeat.calculateHeartbeatCount;
import static no.nordicsemi.android.swaromapmesh.utils.Heartbeat.calculateHeartbeatPeriod;
import static no.nordicsemi.android.swaromapmesh.utils.Heartbeat.periodToTime;
import static no.nordicsemi.android.swaromapmesh.utils.Utils.EXTRA_DATA;
import static no.nordicsemi.android.swaromapmesh.utils.Utils.HEARTBEAT_PUBLICATION_NET_KEY;
...
import no.nordicsemi.android.swaromapmesh.databinding.ActivityHeartbeatPublicationBinding;
...
import no.nordicsemi.android.swaromapmesh.node.dialog.DialogFragmentHeartbeatDestination;
import no.nordicsemi.android.swaromapmesh.node.dialog.DialogFragmentHeartbeatPublishTtl;
import no.nordicsemi.android.swaromapmesh.node.dialog.DialogFragmentTtl;
import no.nordicsemi.android.swaromapmesh.viewmodels.HeartbeatViewModel;
