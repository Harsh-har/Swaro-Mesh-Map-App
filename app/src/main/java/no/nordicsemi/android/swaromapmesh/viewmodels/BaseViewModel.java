...
import static no.nordicsemi.android.swaromapmesh.models.SigModelParser.CONFIGURATION_CLIENT;
import static no.nordicsemi.android.swaromapmesh.models.SigModelParser.CONFIGURATION_SERVER;
import static no.nordicsemi.android.swaromapmesh.models.SigModelParser.SCENE_SERVER;
import static no.nordicsemi.android.swaromapmesh.models.SigModelParser.SCENE_SETUP_SERVER;
import static no.nordicsemi.android.swaromapmesh.models.SigModelParser.SENSOR_SERVER;
...
import no.nordicsemi.android.swaromapmesh.node.ConfigurationClientActivity;
import no.nordicsemi.android.swaromapmesh.node.ConfigurationServerActivity;
import no.nordicsemi.android.swaromapmesh.node.GenericModelConfigurationActivity;
import no.nordicsemi.android.swaromapmesh.node.SceneServerModelActivity;
import no.nordicsemi.android.swaromapmesh.node.SceneSetupServerModelActivity;
import no.nordicsemi.android.swaromapmesh.node.SensorServerActivity;
import no.nordicsemi.android.swaromapmesh.node.VendorModelActivity;
