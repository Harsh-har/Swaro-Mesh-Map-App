...
import static no.nordicsemi.android.swarorgbww.Features.DISABLED;
import static no.nordicsemi.android.swarorgbww.Features.ENABLED;
import static no.nordicsemi.android.swarorgbww.utils.Heartbeat.COUNT_MIN;
import static no.nordicsemi.android.swarorgbww.utils.Heartbeat.DEFAULT_PUBLICATION_TTL;
import static no.nordicsemi.android.swarorgbww.utils.Heartbeat.PERIOD_LOG_MIN;
import static no.nordicsemi.android.swarorgbww.utils.Heartbeat.calculateHeartbeatCount;
import static no.nordicsemi.android.swarorgbww.utils.Heartbeat.calculateHeartbeatPeriod;
import static no.nordicsemi.android.swarorgbww.utils.Heartbeat.periodToTime;
import static no.nordicsemi.android.swarorgbww.utils.Utils.EXTRA_DATA;
import static no.nordicsemi.android.swarorgbww.utils.Utils.HEARTBEAT_PUBLICATION_NET_KEY;
...
import no.nordicsemi.android.swarorgbww.utils.MeshAddress;
import no.nordicsemi.android.swarorgbww.GroupCallbacks;
import no.nordicsemi.android.swarorgbww.R;
import no.nordicsemi.android.swarorgbww.databinding.ActivityHeartbeatPublicationBinding;
import no.nordicsemi.android.swarorgbww.dialog.DialogFragmentError;
import no.nordicsemi.android.swarorgbww.keys.NetKeysActivity;
import no.nordicsemi.android.swarorgbww.node.dialog.DestinationAddressCallbacks;
import no.nordicsemi.android.swarorgbww.node.dialog.DialogFragmentHeartbeatDestination;
import no.nordicsemi.android.swarorgbww.node.dialog.DialogFragmentHeartbeatPublishTtl;
import no.nordicsemi.android.swarorgbww.node.dialog.DialogFragmentTtl;
import no.nordicsemi.android.swarorgbww.viewmodels.HeartbeatViewModel;
