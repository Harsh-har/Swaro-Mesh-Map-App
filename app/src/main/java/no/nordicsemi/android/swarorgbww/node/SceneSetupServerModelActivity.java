...
import static no.nordicsemi.android.swarorgbww.utils.Utils.SELECT_SCENE;
...
import no.nordicsemi.android.swarorgbww.transport.SceneDelete;
import no.nordicsemi.android.swarorgbww.transport.SceneStore;
import no.nordicsemi.android.swarorgbww.R;
import no.nordicsemi.android.swarorgbww.databinding.LayoutSceneSetupServerBinding;
import no.nordicsemi.android.swarorgbww.scenes.ScenesActivity;
import no.nordicsemi.android.swarorgbww.scenes.adapter.SceneUiState;
import no.nordicsemi.android.swarorgbww.scenes.adapter.StoredScenesAdapter;
