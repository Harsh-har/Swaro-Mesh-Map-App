...
import no.nordicsemi.android.swarorgbww.ble.AutoProxyConnectManager;
import no.nordicsemi.android.swarorgbww.ble.ScannerActivity;
import no.nordicsemi.android.swarorgbww.databinding.FragmentGroupsBinding;
import no.nordicsemi.android.swarorgbww.dialog.DialogFragmentDeleteNode;
import no.nordicsemi.android.swarorgbww.dialog.DialogFragmentError;
import no.nordicsemi.android.swarorgbww.node.NodeConfigurationActivity;
import no.nordicsemi.android.swarorgbww.node.adapter.NodeAdapter;
