...
import no.nordicsemi.android.swarorgbww.adapter.FilterAddressAdapter;
import no.nordicsemi.android.swarorgbww.databinding.FragmentProxyFilterBinding;
import no.nordicsemi.android.swarorgbww.dialog.DialogFragmentError;
import no.nordicsemi.android.swarorgbww.dialog.DialogFragmentFilterAddAddress;
import no.nordicsemi.android.swarorgbww.transport.MeshMessage;
import no.nordicsemi.android.swarorgbww.transport.ProxyConfigAddAddressToFilter;
import no.nordicsemi.android.swarorgbww.transport.ProxyConfigRemoveAddressFromFilter;
import no.nordicsemi.android.swarorgbww.transport.ProxyConfigSetFilterType;
