...
import static no.nordicsemi.android.swarorgbww.models.SigModelParser.CONFIGURATION_CLIENT;
...
import static no.nordicsemi.android.swarorgbww.models.SigModelParser.SCENE_SETUP_SERVER;
import static no.nordicsemi.android.swarorgbww.models.SigModelParser.SENSOR_SERVER;
...
import no.nordicsemi.android.swarorgbww.models.VendorModel;
...
import no.nordicsemi.android.swarorgbww.ble.ScannerActivity;
import no.nordicsemi.android.swarorgbww.node.ConfigurationClientActivity;
import no.nordicsemi.android.swarorgbww.node.ConfigurationServerActivity;
import no.nordicsemi.android.swarorgbww.node.GenericModelConfigurationActivity;
import no.nordicsemi.android.swarorgbww.node.SceneServerModelActivity;
import no.nordicsemi.android.swarorgbww.node.SceneSetupServerModelActivity;
import no.nordicsemi.android.swarorgbww.node.SensorServerActivity;
import no.nordicsemi.android.swarorgbww.node.VendorModelActivity;
